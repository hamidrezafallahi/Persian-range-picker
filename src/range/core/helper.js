...
export const getTimestampsForPeriod = (period, locale) => {
    let from, to;
    switch (period) {
        case "today":
...
export const period = (date, locale, zone) => {
    return [
        {
...
export function getLabel(zone, timeZone, locale = "en") {
    switch (timeZone) {
        case "yesterday":
            if (zone == "today") {
                return locale == "fa"
